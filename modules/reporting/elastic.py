...
class ElasticDB(Report):
    """Stores report in Elastic Search."""

    # Elastic schema version, used for data migration.
    SCHEMA_VERSION = "1"
    ...
    def run(self, results):
        ...
        # Set elastic search schema version.
        ...
        ####else:
        ####    self.es.index(index="cuckoo", doc_type="cuckoo_schema", id=1, body={"version": self.SCHEMA_VERSION})
        ...
        for process in report["behavior"]["processes"]:
            ...
            for index, call in enumerate(process["calls"]):
                ...
                if len(chunk) == 100:
                    ...
                    pchunk = self.es.index(index="cuckoo", doc_type="calls", body=to_insert)
                    chunk_id = pchunk['_id']
